...
public class CountSort {
	...
	static void countSort(int a[], int n, int k) {
		 ...
		 * Laufzeit von 2k+4n entsteht durch, k = die for-SChleife über k zum initialisieren 
		 * und die while-Schleife = 2k n = die 4 Operationen innerhalb der n-Schleifen = 4n
		 */
		for (i = 0; i < n; i++) {
			/**
